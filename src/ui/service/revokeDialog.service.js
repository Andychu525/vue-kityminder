angular.module("kityminderEditor").service("revokeDialog", [
  "$modal",
  "minder.service",
  function($modal, minderService) {
          ...
          resolve: {
            ...
            defaultValue: function() {
              var selectedNode = minder.getSelectedNode(),
                Node2Text = window.kityminder.data.getRegisterProtocol("text")
                  .Node2Text;
